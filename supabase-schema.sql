...
CREATE INDEX idx_highlights_active_order
...
-- Writes and reads of inactive rows happen through custom admin RPC functions below.

-- =====================================================
-- 5. STORAGE RLS (for image uploads)
-- =====================================================
...
-- =====================================================
-- 6. CUSTOM ADMIN AUTH + CRUD RPC FUNCTIONS
-- =====================================================
...
BEGIN
  ...
  VALUES (
    p_highlight->>'title',
    COALESCE(p_highlight->>'subtitle', ''),
    COALESCE(p_highlight->>'description', ''),
    COALESCE(p_highlight->>'date_text', ''),
    COALESCE(p_highlight->>'location', ''),
    COALESCE(p_highlight->>'href', ''),
    COALESCE(p_highlight->>'image_url', ''),
    COALESCE((p_highlight->>'sort_order')::integer, 0),
