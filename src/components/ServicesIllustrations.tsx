...
export function SoftwareIllustration() {
  return (
    <svg viewBox="0 0 360 230" fill="none" aria-hidden="true" focusable="false">
      <g stroke="#203c40" strokeWidth="0.7" opacity="0.6">
      ...
      <path d="M78 90v30l78 40m109-73v32l-61 36m-24 13v25l52 25" stroke="#28e98c" strokeOpacity="0.55" strokeWidth="1" strokeLinejoin="round" />
      <path d="m127 181 53-27 53 27-53 26Z" fill="#102a2b" stroke="#28e98c" strokeOpacity="0.28" />
      {[126, 97, 68].map((y, index) => (
        <g key={y}>
          <path d={`M138 ${y}l42-22 42 22v25l-42 22-42-22Z`} fill="#101f2d" stroke="#415160" strokeWidth="0.85" />
          <path d={`M138 ${y}l42 22 42-22-42-22Z`} fill={index === 2 ? '#263c48' : '#1d303c'} stroke="#526673" strokeWidth="0.75" />
          <path d={`M180 ${y + 22}v25l42-22v-25Z`} fill="#0c1b25" stroke="#334653" strokeWidth="0.7" />
          <path d={`m146 ${y + 10} 23 12m-23-5 15 8`} stroke="#72818c" strokeWidth="1.4" />
          <path d={`m188 ${y + 24} 4-2m5-3 4-2m5-3 4-2`} stroke="#28e98c" strokeWidth="2" strokeLinecap="round" />
        </g>
      ))}
      <g transform="translate(49 56)">
        <rect width="57" height="43" rx="10" fill="#10212d" stroke="#2d4a4e" />
      ...
      <g transform="translate(248 58)">
        <rect width="54" height="42" rx="10" fill="#10212d" stroke="#2d4a4e" />
        <path d="m19 14-7 7 7 7m17-14 7 7-7 7m-7-17-5 20" stroke="#28e98c" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </g>
      <g transform="translate(218 179)">
        <rect width="46" height="43" rx="10" fill="#10212d" stroke="#2d4a4e" />
      ...
      <g fill="#28e98c"><circle cx="78" cy="120" r="2" /><circle cx="265" cy="119" r="2" /><circle cx="180" cy="193" r="2" /></g>
    </svg>
  );
}
...
function LandingScreen({ mobile = false }: { mobile?: boolean }) {
  return mobile ? (
    <g>
      <rect width="70" height="136" rx="6" fill="#0e1a22" />
      ...
      <rect x="9" y="79" width="34" height="10" rx="3" fill="#28e98c" />
      <text x="14" y="86" fill="#082018" fontSize="4" fontWeight="700">Get started ↗</text>
      <rect x="9" y="103" width="23" height="21" rx="4" fill="#172c30" stroke="#2a4446" strokeWidth="0.5" />
      <rect x="38" y="103" width="23" height="21" rx="4" fill="#17242f" stroke="#2a3b46" strokeWidth="0.5" />
      <path d="m15 117 4-7 6 9m20-7h10m-10 5h6" stroke="#80b59f" strokeWidth="1" />
    </g>
  ) : (
    <g>
      <rect width="244" height="145" fill="#0e1a22" />
      ...
      <rect x="17" y="108" width="51" height="16" rx="4" fill="#28e98c" />
...
export function FrontendIllustration() {
  return (
    <svg viewBox="0 0 360 230" fill="none" aria-hidden="true" focusable="false">
      <ellipse cx="175" cy="209" rx="146" ry="8" fill="#06101b" opacity="0.5" />
      <rect x="34" y="29" width="270" height="168" rx="10" fill="#101a25" stroke="#596574" strokeWidth="1" />
      <rect x="39" y="33" width="260" height="160" rx="7" stroke="#24313e" />
      <circle cx="169" cy="36" r="1.5" fill="#667480" />
      <svg x="47" y="42" width="244" height="145" viewBox="0 0 244 145"><LandingScreen /></svg>
      <path d="M34 197h270l23 9c0 4-7 7-16 7H27c-9 0-16-3-16-7Z" fill="#283642" stroke="#5d6c78" strokeWidth="0.7" />
      <path d="M12 206h314" stroke="#74818a" strokeOpacity="0.6" />
      <path d="M141 197h57l-5 5h-47Z" fill="#111d27" />
      <g transform="translate(249 73) rotate(5 41 74)">
        <rect width="82" height="154" rx="13" fill="#080f19" stroke="#73818c" strokeWidth="1.2" />
        <g transform="translate(6 8)"><LandingScreen mobile /></g>
        <rect x="28" y="5" width="26" height="5" rx="2.5" fill="#060d15" />
...
function DashboardPhone({ secondary = false }: { secondary?: boolean }) {
  return (
    <g>
      <rect width="106" height="196" rx="17" fill="#09111c" stroke="#73818d" strokeWidth="1.2" />
      <rect x="5" y="5" width="96" height="186" rx="13" fill="#101d2a" stroke="#253543" strokeWidth="0.6" />
      <text x="13" y="17" fill="#d3dde7" fontSize="4.5">9:41</text>
      <path d="M82 13h4m2 0h6" stroke="#bcc8d4" strokeWidth="2" />
      <rect x="39" y="7" width="28" height="6" rx="3" fill="#050c15" />
      ...
      <rect x="12" y="61" width="82" height="68" rx="7" fill="#142532" stroke="#2d434c" strokeWidth="0.6" />
      ...
      {secondary ? [10, 18, 14, 23, 19, 27, 25].map((height, index) => (
        <rect key={index} x={21 + index * 9} y={121 - height} width="5" height={height} rx="1.5" fill={index > 3 ? '#28e98c' : '#2e7560'} />
      )) : <><path d="m19 116 9-5 8 2 10-12 8 3 10-8 9 2 13-7v30H19Z" fill="#28e98c" fillOpacity="0.07" /><path d="m19 116 9-5 8 2 10-12 8 3 10-8 9 2 13-7" stroke="#28e98c" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></>}
...
export function MobileIllustration() {
  return (
    <svg viewBox="0 0 360 230" fill="none" aria-hidden="true" focusable="false">
      <ellipse cx="182" cy="216" rx="107" ry="8" fill="#06101b" opacity="0.5" />
